...
(define DISPOSESCRIPTS_SCRIPT 991)
;Locales
(define regGun		150)
...
(define fTookCarMoneyAir 114)
(define fLockedUpGunAtJail 115)
(define fKenFixedGun 116)
(define fTookDollarFromInn 117)
(define fStolenCarTowed 118)
(define fFoundWomanStolenCar 119)
(define fFuckedPoster 120)
(define fOrderedPizza 121)
(enum 122
	fFoundMarie							;122
