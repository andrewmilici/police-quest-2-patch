...
(instance rm13Script of Script
	...
	(method (doit)
		...
		(if (== local117 1)
			(= local117 0)
			(cond 
                ((ego has: iEarProtectors)
                	(sequencer changeState: 200) 
	            )
...
(instance sequencer of Script
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(200 ;we stole the ear muff - captain to yell at us.
			...
			(201 (LocPrint 1 13 132))			
			(202 (LocPrint 2 13 197))
			(203 (LocPrint 2 13 198))
			(204 (LocPrint 2 13 199))			
			(205 (LocPrint 1 13 171))
			(206 (LocPrint 1 13 173))
			(207
				(NormalEgo)
				(cSound loop: 1 fade:)
				(= gCaptainHallReamScript 2)
				(curRoom newRoom: 36)				
			)
		)
	)
