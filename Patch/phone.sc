...
(instance phoneNumber of Script
	...
	(method (handleEvent event)
		...
		(cond 
			...
			((Said '/5551234')
				(curRoom setScript: bains)
			)
			((Said '/5557821')
				(if (Btst 121)  ;fOrderedPizza
					(localproc_1a28)
				else
					(curRoom setScript: pizzaMan)
				)
			)			
			((Said '/unknownnumber')
				(if (< (Random 1 10) 3)
...
(instance pizzaMan of Script
	(properties)
	
	(method (init param1)
		(super init: param1)
		(person loop: 13 cel: 0 posn: 63 79 stopUpd:)
		(personMouth loop: 11 cel: 0 posn: 68 66 setCycle: EndLoop)
		(RedrawCast)
		(self changeState: 1)
	)
				...
				(switch infoLocation
					(2
						(cond 
							...
							((Said '/pizza') (PersonSpeak 12 131 ))
							((Said '/bains') (PersonSpeak 12 122 ))
...
(instance bains of Script
	(properties)

	(method (init param1)
		(super init: param1)
		(person loop: 12 cel: 0 posn: 63 80 stopUpd:)
		(personMouth loop: 10 cel: 0 posn: 69 63 setCycle: EndLoop)
		(RedrawCast)
		(self changeState: 1)
	)
