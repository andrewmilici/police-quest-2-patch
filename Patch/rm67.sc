...
(instance rm67 of Room
	...
	(method (handleEvent event)
		...
		(cond 
			...
			((Said 'touch/woman')
				(curRoom setScript: womanHit)		
			)
			
			((Said 'ask/shoes')
				(if (<= (shopwoman distanceTo: ego) 50)
					...
					(switch shoeAskCount
						...
						(3
							(afterSearch changeState: 10)
							;(curRoom setScript: womanShoes)
					...
					(++ shoeAskCount)
					;(Print {You ask the woman: Can I have your shoes?})
...
;;;			(2
;;;				(Print 67 86)
;;;				(Print 67 87 #at -1 144)
;;;				(= cycles 5)
;;;			)
;;;			(3
;;;				(afterSearch changeState: 5)
;;;				(self setScript: afterSearch)
;;;				
;;;			)
;;;
