...
(instance mariePosterSex of Script
	(properties)
	...
	(method (changeState newState)
		(switch (= state newState)
			...
			(3
				(ego setMotion: MoveTo 88 135 self)
				
			)
			(4
				(ego setMotion: MoveTo 179 135 self)
				
			)
			(5
				(ego setMotion: MoveTo 189 120 self)
			...
			(8
				(ego setMotion: MoveTo 221 122 self)
			)
			(9
				;(User canInput: 1)
				(stallDoor setCycle: BegLoop self)
			...
			(13
				...
				(ego setMotion: MoveTo 205 118 self)
			...
			;162 132
				(stallDoor stopUpd:)	
				(ego setMotion: MoveTo 205 135 self)
			)
			(16
				(ego setMotion: MoveTo 92 135 self)	
				
			)
			(17
				(ego setMotion: MoveTo 92 118 self)	
...
(instance lockerScript of Script
	...
	(method (handleEvent event &tmp temp0)
		...
		(cond 
			...
			((Said 'fuck/flyer,flyer,button')
				
				(if (Btst fFuckedPoster)
					(LocPrint 5 95)

				else
					
					(curRoom setScript: mariePosterSex)
					(mariePosterSex changeState: 0)					
				)
